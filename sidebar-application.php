<div class="sidebar">
  <ul class="sidebar-search">
    <h1 class="sidebar-title"><a href="application-advice">Application Advice</a></h1>
  </ul>
  <ul class="sidebar-interviews">
    
      <!-- The buttons in the sidebar -->
    <button class="sidebar-tab-button tab-active tablink"><a href="university-of-cambridge">Cambridge Resources</a></button>
    <button class="sidebar-tab-button tablink"><a href="application-advice-engineering">Engineering</a></button>
    <button class="sidebar-tab-button tablink"><a href="application-advice-hsps">HSPS</a></button>
    ...
    <?php if ( $the_query->have_posts() ) : ?>
      ...
      <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
        <div class="sidebar-tab-button tab-active tablink">
